 ...
 *   - `privateAuthServerURL` Private URL for you Realm authorization endpoint, in the case where this is different to the private.
...
function Strategy(options, verify) {
  ...
  const privateUrl = options.privateAuthServerURL || options.authServerURL;

  options.authorizationURL = `${options.authServerURL}/realms/${options.realm}/protocol/openid-connect/auth`;
  options.tokenURL = `${privateUrl}/realms/${options.realm}/protocol/openid-connect/token`;
  ...
  this.name = 'keycloak';
  this._userProfileURL = `${privateUrl}/realms/${options.realm}/protocol/openid-connect/userinfo`;
}
